...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "edu2.youthclub.title": "Student-Youth Club",
    "edu2.youthclub.desc": "The club has been operating at SDU since 2000. Since its founding, about 300 intra-university cultural events, disputes, performances and competitions have been held.",
    "edu2.youthclub.director": "Club Director: Xalide Quliyeva (since 2015)",
  ...
  az: {
    ...
    "edu2.youthclub.title": "Tələbə-Gənclik Klubu",
    "edu2.youthclub.desc": "Klub SDU-da 2000-ci ildən fəaliyyət göstərir. Yarandığı vaxtdan indiyədək 300-ə yaxın universitet daxili mədəni tədbirlər, disputlar, tamaşalar və müsabiqələr keçirilmişdir.",
    "edu2.youthclub.director": "Klub rəhbəri: Xalidə Quliyeva (2015-ci ildən)",
