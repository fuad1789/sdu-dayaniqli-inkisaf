...
export default function SustainableEducationPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <section id="sustainability-topics" className="max-w-6xl mx-auto px-4 py-20 scroll-mt-24">
      ...
      <section id="courses-programs" className="bg-white dark:bg-slate-800/50 border-y border-slate-200 dark:border-slate-700 py-16 px-4 scroll-mt-24">
      ...
      <section id="student-initiatives" className="max-w-6xl mx-auto px-4 py-20 scroll-mt-24">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-8 text-center">
      ...
      {/* Workshops & Seminars */}
      <section id="workshops-seminars" className="max-w-4xl mx-auto px-4 py-20 scroll-mt-24">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-8 text-center">
